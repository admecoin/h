...
static const int64_t STATIC_POS_REWARD = 3.5 * COIN; //Constant reward of 12.5 HLDC per block
static const int64_t POS_REWARD_TIERED_MN_LVL1 = 0 * COIN;  // from 0 block
static const int64_t POS_REWARD_TIERED_MN_LVL2 = 4 * COIN; // from 1000  block
static const int64_t POS_REWARD_TIERED_MN_LVL3 = 8 * COIN;  // from 21001  block
static const int64_t POS_REWARD_TIERED_MN_LVL4 = 12 * COIN;  // from 63001  block
static const int64_t POS_REWARD_TIERED_MN_LVL5 = 24 * COIN;  // from 189001  block
static const int64_t POS_REWARD_TIERED_MN_LVL6 = 36 * COIN;  // from 189001  block
static const int64_t POS_REWARD_TIERED_MN_LVL7 = 64 * COIN;  // from 189001  block
...
static const int64_t MAX_MONEY = 65000000 * COIN;  // 65000000 COINS
...
public:
    ...
    {
        // HeldCoinCoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // HeldCoinCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // HeldCoinCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // HeldCoinCoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // HeldCoinCoin: trust score of block chain
    int nHeight;
#ifndef LOWMEM
    int64_t nMint;
    int64_t nMoneySupply;
#endif
    unsigned int nFlags;  // HeldCoinCoin: block index flags
    enum
    {
