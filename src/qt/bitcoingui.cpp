	...
	nWeight(0)
{
	...
	if (!fUseBlackTheme)
	{
		...
		//progressBar->setStyleSheet("QProgressBar::chunk {background-color:qlineargradient(x1: 0, y1: 0, x2: 1, y2: 0,stop: 0 #ce1029,stop: 1 #a3515b);}");
	...
	QString styleSheet;
	QString cssName=QString(":/images/montskin");
	QFile qFile(cssName);
...
void BitcoinGUI::createActions()
{
	...
	aboutAction = new QAction(QIcon(":/icons/bitcoin1"), tr("&About HeldCoin"), this);
